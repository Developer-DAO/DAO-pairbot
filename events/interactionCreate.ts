...
export const InteractionCreateEvent: any = {
  ...
  execute: async (interaction: Interaction) => {
    ...
    if (
      interaction.client instanceof discordClient &&
    ...
    if (interaction.isButton()) {
      if (
        interaction.customId.includes("dm-invite") ||
        ...
        if (
          interaction.customId.includes("invite-accept") &&
          interaction.user.id == receiver_discord_id
        ) {
